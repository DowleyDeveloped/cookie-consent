...
namespace dowleydeveloped\cookieconsent\controllers;
...
class SettingsController extends Controller {
	...
	public function actionGeneral() : Response {
		...
		return $this->renderTemplate("dowley-cookieconsent/settings/_general", [
			"settings" => $settings,
		]);
	}
	...
	public function actionExclude() : Response {
		...
		return $this->renderTemplate("dowley-cookieconsent/settings/_exclude", [
			"settings" => $settings,
	...
	public function actionGoogle() : Response {
		...
		return $this->renderTemplate("dowley-cookieconsent/settings/_google", [
			"settings" => $settings,
		]);
	}
	...
	public function actionCustomisation() : Response {
		...
		return $this->renderTemplate("dowley-cookieconsent/settings/_customisation", [
			"settings" => $settings,
			"icon" => $icon,
		]);
	}
	...
	public function actionColours() : Response {
		...
		return $this->renderTemplate("dowley-cookieconsent/settings/_colours", [
			"settings" => $settings,
		]);
	}
}
