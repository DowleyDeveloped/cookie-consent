...
use dowleydeveloped\cookieconsent\models\CookieModel;
...
class CookiesController extends Controller
{
	...
	public function actionIndex()
	{
		...
		$variables["elements"] = CookieElement::find()
			->all();
		return $this->renderTemplate("dowley-cookieconsent/cookies/index", $variables);
	}
	...
	public function actionNew(): Response
	{
		...
		return $this->renderTemplate('dowley-cookieconsent/cookies/new', [
	...
	public function actionCreateService(): Response
	{
		...
		if ($serviceKey === 'custom') {
			...
			return $this->redirect('cookie-consent/cookies');
		}
	...
	private function createCookieDraft(): Response
	{
		...
		$response = $this->asModelSuccess($template, Craft::t('dowley-cookieconsent', '{type} created.', [
