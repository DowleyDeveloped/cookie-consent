...
// Cookies
const requiredCookies = JSON.parse(
	settings.requiredCookies.replace(/&quot;/gi, '"'),
);
const functionalCookies = JSON.parse(
	settings.functionalCookies.replace(/&quot;/gi, '"'),
);
const analyticsCookies = JSON.parse(
	settings.analyticsCookies.replace(/&quot;/gi, '"'),
);
const performanceCookies = JSON.parse(
	settings.performanceCookies.replace(/&quot;/gi, '"'),
);
const advertisementCookies = JSON.parse(
	settings.advertisementCookies.replace(/&quot;/gi, '"'),
);
const securityCookies = JSON.parse(
	settings.securityCookies.replace(/&quot;/gi, '"'),
);
				...
				preferencesModal: {
					...
					sections: [
						...
						},
						{
							...
							cookieTable:
								createCookieTable(advertisementCookies),
						},
						{
...
async function logConsent(action = "first") {
	...
	const response = await fetch(
		"actions/dowley-cookieconsent/cookies/log-consent",
		{
			method: "POST",
			headers: {
