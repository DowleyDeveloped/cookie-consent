...
class CookieQuery extends ElementQuery
{
    ...
    {
        $this->joinElementTable("dowley_cookies_enabled");

        $this->query->select([
            "dowley_cookies_enabled.type",
            "dowley_cookies_enabled.cookieId",
            "dowley_cookies_enabled.domain",
            "dowley_cookies_enabled.duration",
            "dowley_cookies_enabled.description",
        ]);

        if ($this->type) {
            $this->subQuery->andWhere([
                "dowley_cookies_enabled.type" => $this->type,
            ]);
        }
