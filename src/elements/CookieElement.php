...
use dowleydeveloped\cookieconsent\records\CookieRecord;

use dowleydeveloped\cookieconsent\elements\fieldlayoutelements\TypeField;
use dowleydeveloped\cookieconsent\elements\fieldlayoutelements\CookieIdField;
use dowleydeveloped\cookieconsent\elements\fieldlayoutelements\DomainField;
use dowleydeveloped\cookieconsent\elements\fieldlayoutelements\DurationField;
use dowleydeveloped\cookieconsent\elements\fieldlayoutelements\DescriptionField;
...
class CookieElement extends Element
{
    ...
    {
        $path = UrlHelper::cpUrl("cookie-consent/cookies/{$this->id}");

        return $path;
    }

    public static function defineNativeFields(
        DefineFieldLayoutFieldsEvent $event
    ): void {
    ...
    {
        return UrlHelper::cpUrl("cookie-consent/cookies");
    }
